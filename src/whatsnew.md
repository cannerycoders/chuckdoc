...
(NOTE) ChAI (ChucK + AI), first started in chuck-1.4.2.0, will continue 
to be in BETA for some time (as we add more and also teach using chAI in 
"Music and AI" at Stanford). The new additions to ChAI will be designated 
[chAI] and may be subject to change in the near future.

(NOTE) [WebChucK](https://chuck.stanford.edu/webchuck) (ChucK on browsers) 
[beta] was released during the development of this version. 
